...
function SideBar({sideBarOpen, setSidebarOpen}) {
    ...
    return (
        <div className={`h-screen w-60 xl:w-72 bg-white border-r border-gray-200 flex flex-col justify-between 
        ...
        ${sideBarOpen ? "translate-x-0" : "max-sm:-translate-x-full"} transition-all duration-300 ease-in-out`}>
            <div className="w-full">
                <img src={assets.logo} className="w-26 ml-7 my-2 cursor-pointer" onClick={() => navigate("/")}/>
